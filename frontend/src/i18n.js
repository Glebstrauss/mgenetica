...
const MESSAGES = {
  ...
  es: {
    ...
    common: { brandName: 'MGenética', brandTagline: 'Mejoramiento animal, del concepto al código', admin: 'Admin', learnerArea: 'Área del estudiante', logout: 'Salir', back: 'Volver', openLiveUrl: 'Abrir sitio publicado', openFile: 'Abrir archivo', available: 'Disponible', active: 'Activo', draft: 'Borrador', reading: 'Lectura', status: 'Estado', skipToContent: 'Saltar al contenido', dedicatedCourse: 'Curso dedicado' },
    localeSwitcher: { label: 'Idioma' },
