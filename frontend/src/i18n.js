...
const MESSAGES = {
  'pt-BR': {
    ...
    status: {
      ...
      verifyEmailRequired: 'Verifique seu e-mail para acessar cursos, quizzes e progresso.',
      verifyingEmail: 'Validando e-mail…',
      emailVerified: 'E-mail verificado. Acesso liberado.',
      verificationMissing: 'Link de verificação incompleto.',
      verificationFailed: 'Não foi possível validar o e-mail.',
    ...
    home: {
      ...
      proofKicker: 'MGenética',
      proofTitle: 'Trilha técnica aplicada',
      proofCopy: 'Melhoramento animal, genética quantitativa e genômica conectados à prática em R.',
      proofMetricsAria: 'Resumo da trilha técnica',
      proofMetricModulesValue: '21',
      proofMetricModulesLabel: 'módulos',
      proofMetricAxesValue: '5',
      proofMetricAxesLabel: 'eixos',
      proofMetricCodeValue: 'R',
      proofMetricCodeLabel: 'aplicado',
      proofConcept: 'Conceito biológico',
      proofCode: 'Código R reprodutível',
      proofDecision: 'Decisão de seleção',
    ...
    verification: {
      brandName: 'Verificação',
      brandTagline: 'Validação de e-mail',
      label: 'Segurança da conta',
      requiredTitle: 'Verifique seu e-mail para liberar a trilha.',
      requiredCopy: 'Enviamos um link de verificação para {email}. Abra o link recebido e retorne para continuar.',
      inboxGuidance: 'Confira também spam, promoções e atualizações. Links antigos podem expirar; solicite novo envio se necessário.',
      resendEmail: 'Reenviar e-mail',
      resendCooldown: 'Reenviar em {seconds}s',
      refreshStatus: 'Atualizar status',
      emailSent: 'Novo e-mail de verificação enviado.',
      emailSendError: 'Não foi possível enviar o e-mail de verificação.',
      accountRefreshed: 'Status da conta atualizado.',
      refreshError: 'Não foi possível atualizar o status da conta.',
      lockedHeading: 'Cursos bloqueados até a verificação',
      lockedCopy: 'A conta está conectada, mas cursos, quizzes, progresso e admin só ficam disponíveis após validar o e-mail.',
      processingTitle: 'Validando e-mail',
      processingCopy: 'Aguarde enquanto confirmamos o link de verificação.',
      successTitle: 'E-mail validado',
      successCopy: 'A verificação foi aceita. Você será direcionado para a trilha de cursos.',
      failedTitle: 'Link inválido ou expirado',
      failedCopy: 'O Appwrite recusou este link. Solicite um novo envio no perfil e use o link mais recente.',
      missingTitle: 'Link incompleto',
      missingCopy: 'Abra o link completo recebido por e-mail ou solicite um novo envio no perfil.',
      nextStepTitle: 'Próximo passo',
      nextStepCopy: 'Entre na conta e solicite um novo e-mail de verificação pelo perfil.'
    },
    catalog: {
      brandName: 'Cursos',
    ...
    account: {
      ...
      securityHeading: 'Sessões e acesso',
      securityCopy: 'Use este painel para revisar o estado de verificação e encerrar sessões quando necessário.',
      currentSession: 'Sessão atual',
      sessionActive: 'Ativa',
      sessionChanging: 'Atualizando…',
  ...
  en: {
    locales: { 'pt-BR': 'PT', en: 'EN', es: 'ES' },
    status: {
      syncing: 'Syncing with Appwrite…', restoringSession: 'Restoring session…', sessionVerified: 'Session verified.', unlockFlow: 'Sign in to unlock the full flow.', loginSuccess: 'Session started successfully.', signupSuccess: 'Account created and session started.', verificationEmailSent: 'Verification email sent. Check your inbox.', verifyEmailRequired: 'Verify your email to access courses, quizzes, and progress.', verifyingEmail: 'Verifying email…', emailVerified: 'Email verified. Access unlocked.', verificationMissing: 'Incomplete verification link.', verificationFailed: 'Could not verify the email.', sessionClosed: 'Session closed.', enterCourses: 'Sign in to access the courses.', enterCoursePage: 'Sign in to access this course page.', notAdmin: 'Current user is not in the admin allowlist.', runningChecks: 'Running system checks…', checksDone: 'System checks completed.', checksFailed: 'Failed to run system checks.', progressSaved: 'Progress saved successfully.', progressUnavailable: 'Signed in, but progress could not be loaded yet.', profileSaved: 'Profile updated successfully.'
    },
    authErrors: {
    ...
    home: {
      signIn: 'Sign in', signInAria: 'Sign in to the platform', openCatalogAria: 'Open courses', openAdminAria: 'Open admin panel', logoutAria: 'Sign out', eyebrow: 'Applied education', headline: 'Genetics for field decisions.', description: 'Study quantitative genetics and genomics through a practical learning path guided by R.', ctaLogin: 'Sign in to open path', ctaSignup: 'Create account', brandMeta1: 'Clear technical content.', brandMeta2: 'Practical path with code.', proofKicker: 'MGenética', proofTitle: 'Applied technical path', proofCopy: 'Animal breeding, quantitative genetics and genomics connected to R practice.', proofMetricsAria: 'Technical path summary', proofMetricModulesValue: '21', proofMetricModulesLabel: 'modules', proofMetricAxesValue: '5', proofMetricAxesLabel: 'axes', proofMetricCodeValue: 'R', proofMetricCodeLabel: 'applied', proofConcept: 'Biological concept', proofCode: 'Reproducible R code', proofDecision: 'Selection decision', benefitsAria: 'Platform pillars',
    ...
    verification: { brandName: 'Verification', brandTagline: 'Email validation', label: 'Account security', requiredTitle: 'Verify your email to unlock the path.', requiredCopy: 'We sent a verification link to {email}. Open the received link and return to continue.', inboxGuidance: 'Also check spam, promotions, and updates. Old links may expire; request a new message if needed.', resendEmail: 'Resend email', resendCooldown: 'Resend in {seconds}s', refreshStatus: 'Refresh status', emailSent: 'New verification email sent.', emailSendError: 'Could not send verification email.', accountRefreshed: 'Account status refreshed.', refreshError: 'Could not refresh account status.', lockedHeading: 'Courses locked until verification', lockedCopy: 'The account is signed in, but courses, quizzes, progress, and admin unlock only after email validation.', processingTitle: 'Verifying email', processingCopy: 'Wait while we confirm the verification link.', successTitle: 'Email verified', successCopy: 'The verification was accepted. You will be redirected to the course path.', failedTitle: 'Invalid or expired link', failedCopy: 'Appwrite rejected this link. Request a new verification email from your profile and use the latest link.', missingTitle: 'Incomplete link', missingCopy: 'Open the full link received by email or request a new one from your profile.', nextStepTitle: 'Next step', nextStepCopy: 'Sign in and request a new verification email from your profile.' },
    ...
    account: { brandName: 'Profile', brandTagline: 'Data, enrollments, and progress', open: 'Manage profile', openAria: 'Open student profile', profileLabel: 'Registration', heading: 'Student data', copy: 'Update your registration data and manage enrolled courses for this account.', name: 'Name', namePlaceholder: 'Your name', email: 'Email', accountId: 'Account ID', emailVerified: 'Email verified', registeredAt: 'Registered', yes: 'Yes', no: 'No', saveProfile: 'Save profile', saving: 'Saving…', profileSaved: 'Profile updated.', profileSaveError: 'Could not save profile.', securityLabel: 'Security', securityHeading: 'Sessions and access', securityCopy: 'Use this panel to review verification state and close sessions when needed.', currentSession: 'Current session', sessionActive: 'Active', sessionChanging: 'Updating…', logoutAll: 'Sign out everywhere', coursesLabel: 'Enrolled courses', coursesHeading: 'Your path and progress', progressOverview: '{tracked} modules with saved progress, {passed} passed, {average}% average.', tracked: 'Tracked modules', passed: 'Passed', average: 'Average', courseProgress: '{percent}% complete', continueCourse: 'Continue module', startCourse: 'Start module' },
  ...
  es: {
    ...
    localeSwitcher: { label: 'Idioma' },
    home: { signIn: 'Entrar', signInAria: 'Entrar a la plataforma', openCatalogAria: 'Abrir cursos', openAdminAria: 'Abrir panel admin', logoutAria: 'Cerrar sesión', eyebrow: 'Educación aplicada', headline: 'Genética para decidir en campo.', description: 'Estudia genética cuantitativa y genómica con una ruta práctica guiada por R.', ctaLogin: 'Entrar para abrir ruta', ctaSignup: 'Crear cuenta', brandMeta1: 'Contenido técnico claro.', brandMeta2: 'Ruta práctica con código.', proofKicker: 'MGenética', proofTitle: 'Ruta técnica aplicada', proofCopy: 'Mejoramiento animal, genética cuantitativa y genómica conectados a la práctica en R.', proofMetricsAria: 'Resumen de la ruta técnica', proofMetricModulesValue: '21', proofMetricModulesLabel: 'módulos', proofMetricAxesValue: '5', proofMetricAxesLabel: 'ejes', proofMetricCodeValue: 'R', proofMetricCodeLabel: 'aplicado', proofConcept: 'Concepto biológico', proofCode: 'Código R reproducible', proofDecision: 'Decisión de selección', benefitsAria: 'Pilares de la plataforma', benefits: { reproducible: { title: 'R reproducible', copy: 'Ejemplos y guiones listos para estudiar con evidencia.' }, science: { title: 'Ciencia aplicada', copy: 'Contenido técnico claro, enfocado en decisiones de campo.' }, access: { title: 'Acceso único', copy: 'Una sola cuenta para ruta, cuestionarios y progreso.' } }, learner: { label: 'Cursos', heading: 'La ruta se abre después del acceso', copy: 'Usa Cursos para abrir cursos y revisar cada página.', openCourses: 'Abrir cursos', logout: 'Salir de la cuenta' }, trustAria: 'Pilares de confianza de MGenética', trust: { rigor: { title: 'Rigor científico', copy: 'Contenido basado en genética cuantitativa, estadística y uso en campo.' }, clarity: { title: 'Lenguaje claro', copy: 'Explicaciones directas, interpretación breve, poca jerga.' }, practice: { title: 'Práctica reproducible', copy: 'Scripts y datos simulados para estudiar sin bases externas.' } } },
    ...
    verification: { brandName: 'Verificación', brandTagline: 'Validación de correo', label: 'Seguridad de la cuenta', requiredTitle: 'Verifica tu correo para liberar la ruta.', requiredCopy: 'Enviamos un enlace de verificación a {email}. Abre el enlace recibido y vuelve para continuar.', inboxGuidance: 'Revisa también spam, promociones y actualizaciones. Los enlaces antiguos pueden expirar; solicita un nuevo envío si es necesario.', resendEmail: 'Reenviar correo', resendCooldown: 'Reenviar en {seconds}s', refreshStatus: 'Actualizar estado', emailSent: 'Nuevo correo de verificación enviado.', emailSendError: 'No fue posible enviar el correo de verificación.', accountRefreshed: 'Estado de la cuenta actualizado.', refreshError: 'No fue posible actualizar el estado de la cuenta.', lockedHeading: 'Cursos bloqueados hasta la verificación', lockedCopy: 'La cuenta está conectada, pero cursos, cuestionarios, progreso y admin se liberan solo después de validar el correo.', processingTitle: 'Verificando correo', processingCopy: 'Espera mientras confirmamos el enlace de verificación.', successTitle: 'Correo verificado', successCopy: 'La verificación fue aceptada. Serás redirigido a la ruta de cursos.', failedTitle: 'Enlace inválido o expirado', failedCopy: 'Appwrite rechazó este enlace. Solicita un nuevo correo de verificación en tu perfil y usa el enlace más reciente.', missingTitle: 'Enlace incompleto', missingCopy: 'Abre el enlace completo recibido por correo o solicita uno nuevo en tu perfil.', nextStepTitle: 'Siguiente paso', nextStepCopy: 'Entra en la cuenta y solicita un nuevo correo de verificación desde tu perfil.' },
    ...
    account: { brandName: 'Perfil', brandTagline: 'Datos, inscripciones y progreso', open: 'Gestionar perfil', openAria: 'Abrir perfil del estudiante', profileLabel: 'Registro', heading: 'Datos del estudiante', copy: 'Actualiza tus datos y gestiona los cursos inscritos en esta cuenta.', name: 'Nombre', namePlaceholder: 'Tu nombre', email: 'Correo', accountId: 'ID de cuenta', emailVerified: 'Correo verificado', registeredAt: 'Registro', yes: 'Sí', no: 'No', saveProfile: 'Guardar perfil', saving: 'Guardando…', profileSaved: 'Perfil actualizado.', profileSaveError: 'No fue posible guardar el perfil.', securityLabel: 'Seguridad', securityHeading: 'Sesiones y acceso', securityCopy: 'Usa este panel para revisar el estado de verificación y cerrar sesiones cuando sea necesario.', currentSession: 'Sesión actual', sessionActive: 'Activa', sessionChanging: 'Actualizando…', logoutAll: 'Cerrar todas las sesiones', coursesLabel: 'Cursos inscritos', coursesHeading: 'Tu ruta y progreso', progressOverview: '{tracked} módulos con progreso guardado, {passed} aprobados, promedio {average}%.', tracked: 'Módulos con progreso', passed: 'Aprobados', average: 'Promedio', courseProgress: '{percent}% completado', continueCourse: 'Continuar módulo', startCourse: 'Iniciar módulo' },
