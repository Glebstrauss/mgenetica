...
const MESSAGES = {
  ...
  es: {
    ...
    verification: { brandName: 'Verificación', brandTagline: 'Validación de correo', label: 'Seguridad de la cuenta', requiredTitle: 'Verifica tu correo para liberar la ruta.', requiredCopy: 'Enviamos un enlace de verificación a {email}. Abre el enlace recibido y vuelve para continuar.', resendEmail: 'Reenviar correo', refreshStatus: 'Actualizar estado', emailSent: 'Nuevo correo de verificación enviado.', emailSendError: 'No fue posible enviar el correo de verificación.', accountRefreshed: 'Estado de la cuenta actualizado.', refreshError: 'No fue posible actualizar el estado de la cuenta.', lockedHeading: 'Cursos bloqueados hasta la verificación', lockedCopy: 'La cuenta está conectada, pero cursos, cuestionarios, progreso y admin se liberan solo después de validar el correo.', processingTitle: 'Verificando correo', processingCopy: 'Espera mientras confirmamos el enlace de verificación.', missingTitle: 'Enlace incompleto', missingCopy: 'Abre el enlace completo recibido por correo o solicita uno nuevo en tu perfil.' },
