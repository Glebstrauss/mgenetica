...
const MESSAGES = {
  'pt-BR': {
    ...
    coursePage: {
      ...
      labEmbedEyebrow: 'Artefato interativo',
      labEmbedTitle: 'Laboratório do módulo',
      labEmbedCopy: 'Use o laboratório embutido para testar os dados do módulo sem sair da página.',
      labEmbedOpen: 'Abrir laboratório em nova aba',
      openQuiz: 'Abrir quiz',
